          ...
          <div className="p-6  border-gray-100 md:w-72">
            ...
            <div className="mt-6 pt-4 border-t border-gray-100">
              ...
              <div className="flex items-center mb-1">
                ...
                <IoStar size={16} fill="#FF8009" stroke="#FF8009" className="mr-1" />
                <span className="text-[#FF8009] font-medium text-sm">{rating}</span>
              </div>
              <div className="flex items-center">
                <span className="text-gray-600 text-sm mr-1">Status:</span>
                <span
                  className={`${status === "Active" ? "text-teal-500" : status === "Inactive" ? "text-red-500" : "text-yellow-500"} text-sm`}
                >
                  {status}
                </span>
              </div>
